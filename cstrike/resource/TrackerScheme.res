...
Scheme
{
	...
	{
		// base colors
		"rojo"			"255 0 0 255"	// used in text windows, lists
		"BaseText"			"255 255 255 210"	// used in text windows, lists
		"BrightBaseText"	"255 255 255 210"	// brightest text
		"SelectedText"		"255 255 255 210"	// selected text
		"DimBaseText"		"168 168 168 255"	// dim base text
		"LabelDimText"		"168 168 168 255"	// used for info text
		"ControlText"		"222 222 222 255"	// used in all text controls
		"BrightControlText"	"255 255 255 255"	// use for selected controls
		"DisabledText1"		"122 122 122 255"	// disabled text
		"DisabledText2"		"44 44 44 255"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"255 255 255 210"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"50 50 50 255"		// background color of controls
		"ControlDarkBG"		"90 90 90 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"90 90 90 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"180 180 180 200"	// background color of any selected text or menu item
		"SelectionBG2"		"40 40 40 255"		// selection background in window w/o focus
		"ListBG"			"20 20 20 200"		// background of server browser, buddy list, etc.
		...
		// border colors
		"BorderBright"		"150 150 150 80"	// the lit side of a control
		"BorderDark"		"0 0 0 100"		// the dark/unlit side of a control
		"BorderSelection"	"0 0 0 60"			// the additional border color for displaying the default/selected button
	}
	...
	BaseSettings
	{
		...
		Slider
		{
			"SliderFgColor"		"140 140 140 255"			// handle with which the slider is grabbed
		...
		"ButtonArmedFgColor"		"255 255 255 255"
		"ButtonArmedBgColor"		"255 255 255 50"
...
//		"ButtonDepressedBgColor"
		...
		InGameDesktop
		{
			...
			"WidescreenBarColor" "0 0 0 150"
			"MenuItemVisibilityRate" "0.03"  // time it takes for one menu item to appear
			"MenuItemHeight"	"36"	//30 or
			"GameMenuInset"		"26"	//40 or
		}
